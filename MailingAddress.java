...
public class MailingAddress {
    ...
    public static void main(String[] args) {
        // input
        System.out.println("Format your mailing address:");
        ...
        // the variables are only 2 letters so that they fit into an argument later
        
        boolean ProvinceCheck = MailingAddress.CheckProvince(Province);
        boolean StreetTypeCheck = MailingAddress.CheckStreetType(StreetType);
        ...
        if (ProvinceCheck == false && StreetTypeCheck == false) {
            ...
            String[] MailingAddressInfo = MailingAddress.MailingAddressObject (
                FirstName,
                LastName,
                HouseNumber,
                StreetName,
            ...
            System.out.println("Your mailing address:");
            System.out.println(MailingAddressInfo[0] + " " + MailingAddressInfo[1]);
            System.out.println(MailingAddressInfo[2] + " " + MailingAddressInfo[3] + " " + MailingAddressInfo [4]);
            System.out.println(MailingAddressInfo[5] + " " + MailingAddressInfo[6] + "  " + MailingAddressInfo[7]);
            }
    }
}
